...
zsh $parentPath/config-make-install_libtiff.sh $name 'ios_arm64' $dirname || exit 1
...
zsh $parentPath/config-make-install_libtiff.sh $name 'ios_arm64_sim' $dirname || exit 1
...
zsh $parentPath/config-make-install_libtiff.sh $name 'ios_x86_64_sim' $dirname || exit 1
...
zsh $parentPath/config-make-install_libtiff.sh $name 'macos_x86_64' $dirname || exit 1
...
zsh $parentPath/config-make-install_libtiff.sh $name 'macos_arm64' $dirname || exit 1
